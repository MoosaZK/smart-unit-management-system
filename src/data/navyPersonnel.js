// Dummy data for Pakistani Navy personnel (Officers and Sailors)

export const navyPersonnel = {
  officers: [
    {
      id: 1,
      name: "Capt. Fahad Ahmed Khan",
      rank: "Captain",
      pNumber: "P-1234",
