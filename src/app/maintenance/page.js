...
export default function Maintenance() {
  return (
      <main className="w-full min-h-screen p-8 bg-gradient-to-br from-slate-50 to-gray-100">
        <h1 className="text-3xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">Maintenance Dashboard</h1>
        ...
        <div className="mb-8 max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-4 text-gray-800">Monthly Trends</h2>
